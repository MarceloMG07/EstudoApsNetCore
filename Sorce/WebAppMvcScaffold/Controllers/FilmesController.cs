...
namespace WebAppMvcScaffold.Controllers
{
    ...
    {
        private readonly WebAppMvcScaffoldContext _context;

        public FilmesController(WebAppMvcScaffoldContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Filme != null ? 
                          ...
                          Problem("Entity set 'WebAppMvcScaffoldContext.Filme'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppMvcScaffoldContext.Filme'  is null.");
            }
            var filme = await _context.Filme.FindAsync(id);
            if (filme != null)
            {
